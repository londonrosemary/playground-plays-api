...
monologue1 = Monologue.create({name: "Scene 5", content: "So that's when I decided I could win in a fight against a Gator...", genre: "Drama", length: "55-65 Seconds", age: 39, gender: "Male", is_copy_available: true, char_name: "Tramar", play_id: play2.id})
monologue2 = Monologue.create({name: "Act I Scene 1", content: "I told her I would never be the first to be cut. Never again.", genre: "Comedy", length: "45-55 Seconds", age: 19, gender: "Female", is_copy_available: true, char_name: "Miranda", play_id: play1.id})
